...
from farm_todo.db.dependencies import get_db_session
from farm_todo.db.utils import create_database, drop_database
from farm_todo.services.rabbit.dependencies import get_rmq_channel_pool
from farm_todo.services.rabbit.lifetime import init_rabbit, shutdown_rabbit
from farm_todo.services.redis.dependency import get_redis_pool
from farm_todo.settings import settings
from farm_todo.web.application import get_app
...
async def _engine() -> AsyncGenerator[AsyncEngine, None]:
    ...
    :yield: new engine.
    """
    from farm_todo.db.meta import meta  # noqa: WPS433
    from farm_todo.db.models import load_all_models  # noqa: WPS433
